...
! function(e) {
    ...
    function p() {
        var e = this,
            ...
            n = e.mapinfo;
        if (i && n) {
            var c, u, p, d, _, h, f, v, y, g, b, x, w, k, z, M, E, A, C, T, S, B, O, F, I, P, R, j, N, L, D, H, q, W, Y, V, Q, X, U, Z, G, J, K, $, ee, te, oe, ie, ne, ae, re, se = e.hooks,
                le = e.plugin_hooks,
            ...
            var me, ue, pe, de, _e, he, fe, ve, ye, ge, be, xe, we, ke, ze, Me, Ee, Ae, Ce, Te, Se, Be, Oe, Fe, Ie, Pe, Re, je, Ne, Le, De, He, qe, We, Ye, Ve, Qe, Xe, Ue, Ze, Ge, Je, Ke, $e, et, tt, ot, it, nt, at, rt, st, lt, ct, mt, ut, pt, dt, _t, ht, ft, vt, yt, gt, bt, xt, wt, kt, zt, Mt, Et, At, Ct, Tt, St, Bt, Ot, Ft, It, Pt, Rt, jt = !1,
                Nt = !1,
                Lt = !1,
                Dt = !1,
                Ht = !1,
                ...
                Yt = !1,
                Vt = !1,
                Qt = { triangle: "M -0.57735,.3333 .57735,.3333 0,-.6666 Z", diamond: "M 0,-0.5 -0.4,0 0,0.5 0.4,0 Z", marker: "m-.015-.997c-.067 0-.13.033-.18.076-.061.054-.099.136-.092.219-.0001.073.034.139.068.201.058.104.122.206.158.32.021.058.039.117.058.175.006.009.011-.004.011-.009.037-.125.079-.249.144-.362.043-.08.095-.157.124-.244.022-.075.016-.161-.026-.229-.048-.08-.134-.136-.227-.146-.013-.0001-.027-.0001-.04-.0001z", heart: "m-.275-.5c-.137.003-.257.089-.3.235-.073.379.348.539.58.765.202-.262.596-.33.576-.718-.017-.086-.065-.157-.13-.206-.087-.066-.208-.089-.311-.05-.055.02-.106.053-.143.098-.065-.081-.169-.127-.272-.125", star: "m0-.549c-.044.126-.084.252-.125.379-.135.0001-.271.0001-.405.002.108.078.216.155.323.233-.002.029-.016.057-.023.085-.032.099-.066.199-.097.298.049-.031.095-.068.143-.101.062-.044.124-.089.185-.133.109.077.216.158.326.233-.04-.127-.082-.253-.123-.379.109-.079.219-.156.327-.236-.135-.0001-.27-.002-.405-.003-.042-.126-.081-.252-.125-.377" },
                Xt = function(e, t, o, i) { null == o && (o = !1), null == i && (i = !1), i || (i = "over" == t ? e.sm.over_attributes : "adjacent" == t ? e.sm.adjacent_attributes : e.sm.attributes), !o || e.sm.image ? e.attr(i) : e.animate(i, D) },
                Ut = function(e, t, i) {
                ...
                no = function(e) { var t = e.sm.type; "state" == t && uo("over_state", [e.sm.id]), "location" == t && uo("over_location", [e.sm.id]), "region" == t && uo("over_region", [e.sm.id]) },
                ao = function(e) { var t = e.sm.type; "state" == t && uo("out_state", [e.sm.id]), "location" == t && uo("out_location", [e.sm.id]), "region" == t && uo("out_region", [e.sm.id]) },
                ro = function(e, t) { var o = e.sm.type; "state" == o && uo("click_state", [e.sm.id, t]), "region" == o && uo("click_region", [e.sm.id, t]), "location" == o && uo("click_location", [e.sm.id, t]) },
                so = function(e, t) { var o = e.sm.type; "state" == o && uo("preclick_state", [e.sm.id, t]), "region" == o && uo("preclick_region", [e.sm.id, t]), "location" == o && uo("preclick_location", [e.sm.id, t]) },
                lo = function(e, t) { var o = e.sm.type; "state" == o && uo("zoomable_click_state", [e.sm.id, t]), "region" == o && uo("zoomable_click_region", [e.sm.id, t]) },
                co = !1,
                mo = (co = !1, !1);
            mo = !1;
            vi(), ti()
            ...
            ! function() {
                ...
                function _() {
                    ...
                    j || Ue.hide(), de.style.left = v + "px", de.style.top = v + "px", g && function() {
                        ...
                        function _(e, t) {
                            if (void 0 === t && (t = "z"), z && "region" != z.sm.type) St.call(z, !0, function() { z = !1, _(e) });
                            else {
                                if ("z" == t && ! function(e) {
                                        ...
                                        if (-1 != x && ("manual" == vt.sm.type || w)) {
                                            var i = ft[x].sm.zooming_dimensions.w,
                                                n = t > i - 1;
                                            if (o && n) { var a = Io(vt, ft[x]); if (a || w) return Bo(ft[x]), !1 }
                                        }
                                ...
                                var i = function(e, t) {
                                    ...
                                    else var o = vt.sm.zooming_dimensions.w / e,
                        ...
                        Ge.transform(c), ve.style.top = f + 2 * v + "px", ve.style.left = v + "px", (Ge = Te.set()).push(u, p), Ke = function() { _(O) }, et = function(e, t) { _(e, t) }, $e = function() { _(1 / O) }, e.zoom_in = Ke, e.zoom_out = $e, Ze.click(Ke), Ge.click($e), Ze.touchend(Ke), Ge.touchend($e)
                    }()
                }
            }()
        }
        ...
        function go() {
            ...
            ! function() {
                ...
                for (var n in E)
                    for (var a in it[n] = Object.create(e), E[n].url && (it[n].zoomable = !1), E[n]) "default" != E[n][a] && (it[n][a] = E[n][a]), "yes" == E[n][a] && (it[n][a] = !0), "no" == E[n][a] && (it[n][a] = !1)
            }(),
            function() {
            ...
            function() {
                ...
                var t = "no" == _.import_labels ? {} : n.default_labels,
                    o = function(o) { for (var i in rt[o] = Object.create(e), t[o]) "default" != t[o][i] && (rt[o][i] = t[o][i]), "yes" == t[o][i] && (rt[o][i] = !0), "no" == t[o][i] && (rt[o][i] = !1) },
                    i = function(t) { for (var o in rt[t] || (rt[t] = Object.create(e)), q[t]) "default" != q[t][o] && (rt[t][o] = q[t][o]), "yes" == q[t][o] && (rt[t][o] = !0), "no" == q[t][o] && (rt[t][o] = !1) };
                for (var a in t) o(a);
                for (var a in q) i(a);
                ct = function(e) { o(e), i(e) }
            }(),
            function() {
                var e = {},
            ...
            function() {
                ...
                for (var o in t)
                    for (var n in mt[o] = Object.create(e), t[o]) "default" != t[o][n] && (mt[o][n] = t[o][n]), "yes" == t[o][n] && (mt[o][n] = !0), "no" == t[o][n] && (mt[o][n] = !1)
            }()
        }
        ...
        function bo(e, t) {
            ...
            function c(e, t, i) { var n = /lat[ ]?<[-]?(\d+[\.]?\d+)/g.exec(d); if (n && e > o.to_float(n[1])) return !1; var a = /lat[ ]?>[-]?(\d+[\.]?\d+)/g.exec(d); if (a && e < o.to_float(a[1])) return !1; var r = /lng[ ]?<[-]?(\d+[\.]?\d+)/g.exec(d); if (r && t > o.to_float(r[1])) return !1; var s = /lat[ ]?>[-]?(\d+[\.]?\d+)/g.exec(d); return !(s && e < o.to_float(s[1])) }
            var m = n.proj_rules;
            if (m)
        ...
        function xo(e) {
            ...
            var t, i = o.rotate_bbox(e.sm.bbox, Pe),
                n = i.x,
                a = i.y,
                r = i.width,
                s = i.height,
                ...
                c = ke * we,
                m = ze * we;
            return n -= .5 * (r / l - r), a -= .5 * (s / l - s), (r /= l) / (s /= l) > Ce ? (a -= (m * (t = r / c) - s) / 2, s = r / Ce) : (n -= (c * (t = s / m) - r) / 2, r = s * Ce), { x: n, y: a, w: r, h: s, r: t }
        }
        ...
        function ko(e) { if (e) { e.stop(), e.attr(e.sm.attributes); for (var t = 0; t < e.sm.states.length; ++t) { Qo(ht[e.sm.states[t]], "reset", !1, "region") } } }

        function zo() { qe.forEach(function(e) {-1 != e.sm.id && ko(e) }) }
        ...
        function Ao(e, t) {
            var i = e.sm.type;
            Ue.hide(),
                function(e, t) { We.hide(), We.forEach(function(o) { o.sm.hide || (Mo(o, e) && o.show(), o.sm.scale && Eo(o, qo(o, (Ae > o.sm.scale_limit ? Ae : o.sm.scale_limit) * we), t)) }) }(e, t),
                function(e, t) {
                ...
                }(e, t), o.x_in_array(i, ["state", "region", "out"]) && zo(), "region" == i ? wo(e) : "state" == i ? wo(ft[e.sm.region]) : "manual" == i && qe.forEach(function(e) {-1 != e.sm.id && (e.sm.zooming_dimensions.r > Ae && e.sm.zoomable ? wo(e) : ko(e)) }), "out" != i && "manual" != i ? (He.stop(), De.stop(), He.attr({ "fill-opacity": W }), De.attr({ "fill-opacity": W }), e.stop(), e.attr({ "fill-opacity": 1 }), e.sm.labels.forEach(function(e) { e.sm && e.sm.pill && (e.sm.pill.stop(), e.sm.pill.attr({ "fill-opacity": 1 })) }), e.animate({ "stroke-width": e.sm.border_hover_size * (be / ke) * Ee * 1.25 }, 1e3 * S)) : (He.attr({ "fill-opacity": 1 }), De.attr({ "fill-opacity": 1 })), He.animate({ "stroke-width": Z * (be / ke) * Ee * 1.25 }, 1e3 * S)
        }
        ...
        function To(e) { return { x: e.x, y: e.y, w: e.w, h: e.h } }

        function So() { z.sm && M && (Rt.hide(), M = !1, z.sm && St.call(z), re = !1) }
        ...
        function Bo(i, n, a) {
            if (!Dt) {
                ...
                if (Ae = i.sm.zooming_dimensions.r, Ao(i, n), ie || me && !B || n) dt = r, Te.setViewBox(r.x, r.y, r.w, r.h, !1), c();
                    ...
                    pt = l.tween({ from: s, to: r, duration: 1e3 * S, easing: "easeOutQuad", step: function(e) {! function(e) { dt = e, Te.setViewBox(e.x, e.y, e.w, e.h, !1) }(e) }, finish: function() { c() } })
                }
            }

            function c() { Co(i), vt = i, Dt = !1, re = !1, e.zoom_level = vt.sm.type, e.zoom_level_id = !!vt.sm.id && vt.sm.id, uo("zooming_complete", []), o.isFunction(a) && a() }
        }
        ...
        function Po(e, t) {
            ...
            return Raphael._preload(t.image_url, function() {
                var e = this.offsetWidth,
                    o = this.offsetHeight,
                    i = e / o;
                var n, a, r = function() { var n = t.image_size; return f ? v || g ? n = i > 1 ? e > w ? 1 : e / w : o > k ? 1 / z : o / k / z : b && (n = i / z, n = i > z ? n : 1 / n) : n > 1 && (n = t.image_size * Ee / w), n }(),
                    s = w * r,
                    l = s / i,
                    c = 0,
                    u = 0;
        ...
        function Ro(e) {
            ...
            for (var o in _t = function(e) {
                    ...
                    if (r.sm.image = !1, i.image_url && !ie) {
                        var d = Po(r, { hover: !1, image_url: i.image_url, image_size: i.image_size, image_position: i.image_position, image_x: i.image_x, image_y: i.image_y, image_color: i.image_color, bg_opacity: i.image_background_opacity });
                        if (r.sm.image = !0, s.fill = d, i.image_hover_url) {
                            d = Po(r, { hover: !0, image_url: i.image_hover_url, image_size: i.image_hover_size, image_position: i.image_hover_position, image_x: i.image_hover_x, image_y: i.image_hover_y, image_color: i.image_hover_color, bg_opacity: i.image_background_opacity });
                            u.fill = d
                        } else u.fill = d
                    }
        ...
        function jo() { Ne.attr({ fill: _.background_color, "fill-opacity": Y, stroke: "none" }) }
        ...
        function No(e) {
            if (e || (ft = {}), E)
                for (var t in E) {
                    var i = it[t],
                        ...
                        a = e ? ft[t] : Te.set();
                    if (!e) {
                        if (a.sm = {}, a.sm.states = [], ft[t]) { console.log("Duplicate Regions"); continue }
            ...
            if (!e) {
                ...
                var d = o.clone(Me);
                if (d.width = d.x2 - d.x, d.height = d.y2 - d.y, p.sm.bbox = d, p.sm.zooming_dimensions = xo(p), vt = p, "object" == typeof x ? ((yt = {}).sm = { type: "manual", zp: 1, bbox: x }, yt.sm.zooming_dimensions = xo(yt), x = -1, w = !1) : -1 == x || x in ft || (x in ht ? (Vt = ht[x], w = !1) : console.log("The initial_zoom is not the id of a region or state"), x = -1), v) {
                    ft[-2] = {};
                    var _ = ft[-2];
        ...
        function Wo(e) {
            ...
            for (var t in o.clear_sets([We]), kt = {}, zt = function(e) {
                    var t = "center",
                        n = ot[e];
                    if ("image" != n.type) var a = { "stroke-width": n.border * we * Ee, stroke: n.border_color, fill: n.color, opacity: n.opacity, cursor: "pointer" },
                    ...
                    var m = o.rotate([c.x, c.y], Pe),
                        u = { x: m[0], y: m[1] };
                    if ("auto" == n.size) { var d = { sm: {} }; return d.sm.display = n.display, d.sm.auto_size = !0, d.sm.type = "location", d.sm.hide_label = !1, d.sm.labels = [], d.sm.point0 = c, d.sm.x = u.x, d.sm.y = u.y, d.sm.shape_type = s, d.sm.id = e, void(kt[e] = d) }
                    if ("circle" == s) var _ = Te.circle(u.x, u.y, .5 * l),
                        h = { x: u.x - .5 * l * Ae, y: u.y - .5 * l * Ae, x2: u.x + .5 * l * Ae, y2: u.y + .5 * l * Ae };
        ...
        function Qo(e, t, o, i) { e.sm.labels && e.sm.labels.forEach(function(e) { if (e.sm) { var n = e.sm.pill; "over" == t ? (e.stop(), Xt(e, "over"), n && Ut(n, "over")) : "reset" != t && "out" != t || (Xt(e, "out"), n && (Ut(n, "out", i), o && Ut(n, "adjacent", i))) } }) }

        function Xo() {
            Bt = function() { this.sm.parent && Tt.call(this.sm.parent) }, Ot = function() { this.sm.parent && St.call(this.sm.parent) }, At = function(e) { this.sm.parent && Ct.call(this.sm.parent, e) }, Mt = function(e, t) {
                if (e.sm.pulse || t) {
                ...
                if (io(), ri(), (this.id || "set" != !this.type) && !Zt && !co) {
                    ...
                    if (jt = e.sm.popup_off, !(Ht || qt || Dt || M && re)) {
                        if (Jt && !k) return !1;
                        if (Jt = this, e && (function(e) { e.sm.labels && e.sm.labels.forEach(function(t) { e.sm.inactive ? t.attr({ cursor: "default" }) : t.attr({ cursor: "pointer" }) }) }(e), !e.sm.inactive))
                            if (function(e) { "state" == e.sm.type && e.sm.emphasizable && (Zt = !0, e.insertBefore(Be), setTimeout(function() { Zt = !1 }, 1)) }(e), no(e), t) {
                                if (!M) {
            ...
            Ct = function(o) {
                if (!(Dt || Ht || qt)) {
                    me && (t = !0, setTimeout(function() { t = !1 }, 500)), t || So();
                    var i = Yo(this);
                    if (!i.sm.inactive && (so(i, o), !e.ignore_clicks)) {
                        ...
                        if (re && Rt.update_pos(), jt = i.sm.popup_off, !i.sm.zoomable || "region" != i.sm.type && vt == i && "out" != i.sm.type)
                            if (re) {
                                ...
                                a && (a.onclick = function() { return Rt.hide(), M = !1, z.sm && St.call(z), re = !1, uo("close_popup", []), !1 })
                            } else { ro(i, o); var r = i.sm.url; if ("" != r && !mo) { var s = "javascript" == r.substring(0, 10); return !X || s ? void(s ? window.location.href = r : window.top.location.href = r) : (window.open(r, "_blank"), void Rt.hide()) } }
                        else lo(i, o), ri(), z && z.sm ? St.call(z, !0, function() { Bo(i), z = i }) : (Bo(i), z = i);
                        var l, c
                    }
                }
            }, Ft = function(e) {
                if (void 0 === e && (e = !1), uo("back", []), ("out" == vt.sm.type || "region" == vt.sm.type && w) && j) window.location.href = "javascript:" + j;
                else if (V && "state" == vt.sm.type && vt.sm.region) z ? St.call(z, !0, function() { Bo(ft[vt.sm.region]) }) : Bo(ft[vt.sm.region], !1, e);
                else {
                    var t = Io(vt, ft[x]),
                        o = "manual" == vt.sm.type && t ? ft[x] : ft[-1];
                    z && z.sm && "region" != z.sm.type ? St.call(z, !0, function() { Bo(o) }) : Bo(o, !1, e)
                }
            }, It = function() { Ft() }
        }

        function Uo(e) { if (e.touches) { var t = e.changedTouches ? e.changedTouches[0] : e.touches[0]; return { x: t.clientX, y: t.clientY } } var o = ne ? e.clientY + document.documentElement.scrollTop : e.pageY; return { x: ne ? e.clientX + document.documentElement.scrollLeft : e.pageX, y: o } }
        ...
        function Zo() {
            ...
            o.addEvent(fe, "touchstart", t), o.addEvent(fe, "touchmove", t), o.addEvent(fe, "touchend", function(t) { e = !1, setTimeout(function() { qt = !1 }, 100) })
        }

        function Go() { He.toBack(), Ve.toBack(), je.toBack(), Fe && Fe.toFront(), Qe.toFront(), Ye.toFront(), Oe.toFront() }
        ...
        function Jo(e) {
            if (!e) {
                ae ? (He.mouseup(Ct), je.mouseup($t), Ue.mouseup(It), je.mouseup(ri)) : (He.hover(Tt, St), He.click(Ct), je.click($t), Ue.click(It), je.hover(ri, ri)), b && function() {
                    function e() { Ko() }
                    var t;
                    Pt = function() { clearTimeout(t), t = setTimeout(e, 300) }, window.addEventListener ? (window.addEventListener("resize", Pt, !1), window.addEventListener("orientationchange", Pt, !1)) : (window.attachEvent("resize", Pt, !1), window.attachEvent("orientationchange", Pt, !1));
                    ...
                    function l(t) {
                        ...
                        var o = e(t);
                        Te.setViewBox(o.x, o.y, o.w, o.h), dt = o, (vt = { sm: {} }).sm.zooming_dimensions = dt, vt.sm.type = "manual", a = !1, setTimeout(function() { Ht = !1 }, 1), Ue.show()
                    }
                ...
                }(), Zo()), he.mouseIsOver = !1, he.onmouseover = function() { this.mouseIsOver = !0 }, he.onmouseout = function() { this.mouseIsOver = !1 }, he.onwheel = function(e) { he.mouseIsOver && g && A && (e.preventDefault(), e.deltaY < 0 ? Ke() : $e()) }, o.addEvent(document, "keyup", function(e) {
                    if ("auto" == f) {
        ...
        function Ko() {
            if (!(he.offsetWidth < 1)) {
                ...
                He && We && (He.forEach(function(t) { t.attr({ "stroke-width": e }), t.sm.attributes["stroke-width"] = e, t.sm.over_attributes["stroke-width"] = t.sm.border_hover_size * (be / ke) * Ee * 1.25 }), We.forEach(function(e) { "image" != ot[e.sm.id].type && (e.sm.attributes["stroke-width"] = ot[e.sm.id].border * (be / ke) * Ee * 1.25, e.sm.over_attributes["stroke-width"] = ot[e.sm.id].hover_border * (be / ke) * Ee * 1.25, e.attr({ "stroke-width": e.sm.attributes["stroke-width"] })) }), Se.forEach(function(e) {
        ...
        function $o(e) {
            ...
            if (w && -1 != x) {
                ...
                return Fe.forEach(function(e) { Raphael.isPointInsideBBox(o.sm.bbox, e.sm.bbox.x, e.sm.bbox.y) && e.show() }), void(!e && v && Bo(ft[x]))
            }
            je.show(), Be.show(), Ie.show(), Fe.show(), e || !v || Vt || yt || Bo(ft[x])
        }

        function ei(e) { po(), go(), Ro(!0), No(!0), Wo(), Do(), jo(), Ao(vt, !0), Go(), Jo(!0), Ko(), $o(!0), Co(vt), yi(), io(!0), uo("refresh_complete", []), o.isFunction(e) && e() }
        ...
        function ti(t) {
            ...
            (i = e.mapdata, n = e.mapinfo, _e && delete window.paper, vi(), function() {
                ...
                show: function(e) { jt || (h = !1, null == O && Rt.create(), O.style.display = "block", O.style.zIndex = 2, O.style.maxWidth = ut + "px", O.innerHTML = e.sm.content, Rt.update_pos(e)) },
                reset_pos: function(e, t, o) { null == O && Rt.create(), Rt.set_pos(0 + t, 0 + e, o) },
                update_pos: function(e) { Rt.set_pos(r, m, e) },
                pos: function(e, t) { t ? (r = t.u, m = t.l) : (r = ne ? event.clientY + document.documentElement.scrollTop : e.pageY, m = ne ? event.clientX + document.documentElement.scrollLeft : e.pageX), r -= j, m -= R, jt || k || h || M && re || Rt.set_pos(r, m) },
                set_pos: function(e, t, o) {
                    if (O) {
                        ...
                        if (o && o.sm.on_click && ("yes" == I || "auto" == I && be < 401) || i) {
                            ...
                            if (B = 0 + .5 * xe, t > (S = 0 + .5 * be) && e > B) r = 4;
                            else if (t < S && e > B) r = 3;
                            else if (t > S && e < B) r = 2;
                            else var r = 1;
                ...
                hide: function() { null != O && (O.style.display = "none"), (F = o.findPos(_e)) && (R = F[0], j = F[1]) }
                ...
                Wo(), Do(),
                    function() {
                        ...
                        if (e) {
                            for (var t in e) {
                                ...
                                var d = r || o.path,
                                    _ = Te.path(d);
                                _.transform(Pe), _.attr({ stroke: n.color, fill: "none", cursor: "pointer", "stroke-dasharray": [n.dash], "stroke-width": a, "stroke-linejoin": "round", "stroke-miterlimit": 4 }), _.sm = {}, _.sm.size = n.size, _.sm.bbox = _.getBBox(!0), ie || _.node.setAttribute("class", "sm_line_" + t), Fe.push(_)
                            }
                            Fe.hide()
                        }
                    }(),
                    function() {
                        ...
                        (c = document.createElement("select")).options.add(new Option(e, "-1")), c.options.add(new Option("Back", "back")), c.options.add(new Option("Zoom in", "in")), c.options.add(new Option("Zoom out", "out")), c.options.add(new Option("Left", "left")), c.options.add(new Option("Right", "right")), c.options.add(new Option("Up", "up")), c.options.add(new Option("Down", "down")), c.style.marginRight = ".5em", c.style.marginTop = ".5em", c.style.float = "left", ye.appendChild(c), c.onchange = function(e) { if ("-2" == this.value) return !1; "back" == this.value && Ft(), "out" == this.value && $e(), "in" == this.value && Ke(), "left" == this.value && et("-.25", "x"), "right" == this.value && et(".25", "x"), "up" == this.value && et("-.25", "y"), "down" == this.value && et(".25", "y"), setTimeout(function() { this.value = "-1" }, 500) };
                        ...
                        for (var r in a) {
                            ...
                            if (!(l < 1 || l < 2 && "region" == r)) {
                                ...
                                for (var m in c.options.add(new Option(s.title, "-1")), c.style.marginRight = ".5em", c.style.marginTop = ".5em", c.style.float = "left", s.array) { var u = s.array[m]; "out" == u.sm.type || u.sm.inactive || u.sm.hide || c.options.add(new Option(u.sm.name, u.sm.id)) }
                                c.onchange = o.callback_closure({ entry: s, dropdown: c }, function(e) {
                                    ...
                                    var i = o.array[t.value],
                                        ...
                                        a = function() {
                                            var e = i.sm.on_click;
                                            i.sm.on_click = !0, i.sm.content = Fo(i), si(i.sm.type, i.sm.id, function() { i.sm.on_click = e, i.sm.content = Fo(i) })
                                        };
                                    if ("state" == n) {
                                        function r() { i.sm.zoomable || i.sm.region ? ii(i.sm.id, a) : a() }
                                        Gt(z, r)
                                    } else if ("location" == n) {
                                        function r() { ai(i.sm.id, 4, a) }
                                        Gt(z, r)
                                    } else if ("region" == n) {
                                        function r() { ni(i.sm.bbox, 1, a) }
                                        Gt(z, r)
                                    }
                                }), ye.appendChild(c)
                            }
                    ...
                    function() {
                        if (!(!i.legend || !i.legend.entries || i.legend.entries.length < 1 || ne && ie)) {
                            var e = {};
                            map_legend.style.left = "0em", map_legend.style.bottom = "0em", map_legend.style.padding = ".8em";
        ...
        function oi(e, t) { Bo(ft[e], !1, t) }

        function ii(e, t) { Bo(ht[e], !1, t) }

        function ni(e, t, o) { void 0 === t && (t = 4), void 0 === o && (o = function() {}), Bo({ sm: { type: "manual", zp: t, bbox: e } }, !1, function() { o(), Ue.show() }) }
        ...
        function ai(e, t, o) {
            ...
            var i = { sm: { type: "manual", zp: t } },
                ...
                l = n.sm.y - .5 * r,
                c = a / (ke * we);
            i.sm.zooming_dimensions = { x: s, y: l, w: a, h: r, r: c }, Bo(i, !1, function() { o(), Ue.show() })
        }

        function ri() { Jt && St.call(Jt), k && (k = !1, re || (Rt.hide(), M = !1)) }
        ...
        function si(t, o, i) {
            ...
            return p || d ? oi("-1", function() { si(t, o, i) }) : n.sm.region && "out" == e.zoom_level ? oi(n.sm.region, function() { si(t, o, i) }) : (k = !0, a ? Ct.call(n) : Tt.call(n), Rt.reset_pos(m, u, n), h = !0, k = !1, i(), !0)
        }
        ...
        function ci() { Rt.hide(), M = !1, re ? St.call(z) : Jt && St.call(Jt) }
